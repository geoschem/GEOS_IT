...
!
  ! Lon & lat
  INTEGER, PARAMETER :: IMX = 1152
  INTEGER, PARAMETER :: JMX = 721
!
! !LOCAL VARIABLES:
!
  ! Scalars
  ...
  fileName = '/as/cache-old/2011-08/bmy/DAS.ops.asm.const_2d_asm_Nx.GEOS572.00000000_0000.V01.nc4'
  ...
  fileName = 'Geos57TemplateFile.nc'
