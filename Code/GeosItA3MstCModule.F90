...
!  20 Sep 2013 - R. Yantosca - Renamed to GeosItA3MstCModule.F90
...
100 FORMAT ( '%%% Defining netCDF file vars & attrs for ', a' grid' )
    ...
    !(jxu, 2015/12/08, add nested Asia, adding , 'nested IN')
...
!
! !REVISION HISTORY:
!  11 Aug 2010 - R. Yantosca - Initial version, based on GeosItA6Module.F90
...
!
    ...
    !(jxu, 2015/12/08, add nested Asdia)
    ...
    DO H = 1, TIMES_A3
       ...
       DO F = 1, nFields
          ...
          IF ( doNestSe ) THEN
             ...
             CALL NcWr( Ptr, fOutNestSe, TRIM( name8 ), st4d, ct4d )
             NULLIFY( Ptr )
          ENDIF
